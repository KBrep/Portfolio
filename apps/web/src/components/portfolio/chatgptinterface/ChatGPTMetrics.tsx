...
const metrics: Metric[] = [
  { value: "3", label: "Core User Scenarios" },
  { value: "12", label: "Sources Reviewed" },
  { value: "5", label: "Key Design Modules" },
  { value: "3", label: "Evaluation Methods" },
  { value: "2", label: "Peer Review Sessions" },
  { value: "4", label: "Iterative Wireframe Rounds" },
  { value: "1", label: "Interactive Prototype" },
];

export default function ChatGPTMetrics() {
