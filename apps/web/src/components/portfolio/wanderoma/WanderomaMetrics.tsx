...
const metrics: Metric[] = [
  { value: "2", label: "Testing Rounds" },
  { value: "9", label: "Total Participants" },
  { value: "25+", label: "Wireframe Screens" },
  { value: "4", label: "Speculative Features" },
];

export default function WanderomaMetrics() {
