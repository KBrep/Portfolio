...
const metrics: Metric[] = [
  { value: "6.14/7", label: "Usability Rating" },
  { value: "74%", label: "Hypothesis Validation" },
  { value: "4", label: "Rounds of Testing" },
  { value: "4", label: "Participants" },
  { value: "5", label: "Interviews Conducted" },
  { value: "11", label: "Papers Reviewed" },
  { value: "4", label: "Core Hypotheses" },
];

export default function SenseMetrics() {
